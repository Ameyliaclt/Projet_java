...
public class Vue_rsrv extends JFrame{
	...
	public Vue_rsrv(Hotel ht, Chambre[] cha, Date arr, Date depa){
		h = ht;
		ch = cha;
		a = arr;
		d = depa;

		Dimension t_scr = Toolkit.getDefaultToolkit().getScreenSize();//Height => 864
		...
		heure_ar = new JLabel("<html> Heure : "+ifZero_h(a)+""+a.heure+"h"+ifZero_m(a)+""+a.minute+"</html>");
		...
		heure_dep = new JLabel("<html> &emsp &emsp Heure : "+ifZero_h(d)+""+d.heure+"h"+ifZero_m(d)+""+d.minute+"</html>");
		...
		pnm = new JTextField("Entrez votre prénom.");
		pnm.setFont(new Font("Georgia", Font.PLAIN, 12));
		SearchFieldController search_pnm = new SearchFieldController(pnm, "Entrez votre prénom.", Color.BLACK, Color.BLACK);
		pnm.addFocusListener(search_pnm);
		pnm_nm.add(pnm);

		nm = new JTextField("Entrez votre nom.");
		nm.setFont(new Font("Georgia", Font.PLAIN, 12));
		SearchFieldController search_nm = new SearchFieldController(nm, "Entrez votre nom.", Color.BLACK, Color.BLACK);
		nm.addFocusListener(search_nm);
		pnm_nm.add(nm);

		infos_clt.add(pnm_nm);

		adresse = new JTextField("Entrez votre adresse.");
		adresse.setFont(new Font("Georgia", Font.PLAIN, 12));
		SearchFieldController search_adresse = new SearchFieldController(adresse, "Entrez votre adresse.", Color.BLACK, Color.BLACK);
		adresse.addFocusListener(search_adresse);
		infos_clt.add(adresse);
		...
		tel = new JTextField("Entrez votre numéro de téléphone.");
		tel.setFont(new Font("Georgia", Font.PLAIN, 12));
		SearchFieldController search_tel = new SearchFieldController(tel, "Entrez votre numéro de téléphone.", Color.BLACK, Color.BLACK);
		tel.addFocusListener(search_tel);
		tel_mail.add(tel);

		mail = new JTextField("Entrez votre adresse mail.");
		mail.setFont(new Font("Georgia", Font.PLAIN, 12));
		SearchFieldController search_mail = new SearchFieldController(mail, "Entrez votre adresse mail.", Color.BLACK, Color.BLACK);
		mail.addFocusListener(search_mail);
		tel_mail.add(mail);
	...
	public Vue_rsrv(Hotel ht, Client c, Chambre[] cha, Date arr, Date depa){
		...
		adresse_c = new JLabel("<html>"+clt.ad_p_cl+"</html>");
		adresse_c.setFont(new Font("Georgia", Font.PLAIN, 12));
		infos_clt.add(adresse_c);
